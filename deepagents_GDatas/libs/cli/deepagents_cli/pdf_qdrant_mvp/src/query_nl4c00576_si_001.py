"""
查询 nl4c00576_si_001 集合中关于双原子催化剂合成的数据
每次执行生成一个新的JSON文件，所有文件保存到 queried_datas 目录
"""
...
def query_nl4c00576_si_001():
    ...
    try:
        results = manager.search(
            ...
            query_text=query,
            n_results=10,  # 获取更多结果
            score_threshold=0.3  # 降低阈值以获取更多相关内容
        )
        ...
        output_filename = f"nl4c00576_si_001_query_{timestamp}.json"
