...
class CatalystInfoExtractor:
    ...
    该工具用于从已索引到 Qdrant 的科学论文中提取单原子催化剂的合成信息。
    结合向量搜索和大语言模型，自动识别和结构化提取催化剂合成条件、
    活性位点、前驱体等关键信息。
    
    Use this tool when you need to:
    - Extract single-atom catalyst synthesis information from scientific papers
    - Search for catalyst preparation methods in indexed documents
    - Structure unstructured catalyst data from research papers
    - Retrieve experimental details for catalyst synthesis
    """
