...
set MARKDOWN_DIR=markdown_output_3001-4000
...
if not exist "%MARKDOWN_DIR%" (
    ...
    echo 请确保 markdown_output_3001-4000 目录存在
    pause
    exit /b 1
)
...
REM 执行 Python 脚本
python "%PYTHON_SCRIPT%" --md-dir "%MARKDOWN_DIR%" --chunk-size 1000 --chunk-overlap 200
